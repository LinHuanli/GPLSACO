...
机器证据：[hard_operations_results.json](../../../../results/v1/hard_operations_results.json)。前序 [批量Engine报告](2026-09-08_batch_engine.md) 对应提交 `6a791a3` 的计时结果；本次修改共同内核后的正确性已重新回归，不把旧计时数值宣称为本次版本的性能。
