...
SPEC = importlib.util.spec_from_file_location(
    "e1_resource_wait", ROOT / "scripts/wait_e1_resource.py"
)
...
def test_wait_and_repeat_only_explicit_pre_submission_pause(tmp_path, monkeypatch, final_phase):
    ...
    request = {
        ...
        "freeze": "artifacts/e1/protocol-v1",
        "condition": "GP-Full",
        "evolution_seed": 1103,
        "sources": {"scripts/wait_e1_resource.py": file_hash(ROOT / "scripts/wait_e1_resource.py")},
    }
